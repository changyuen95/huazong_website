...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="topbar-one" style="background-color:#EB1757">
        ...
        <nav class="main-nav-one stricky">
            <div class="container" style="padding-left:0px;padding:right:0px">
                <div class="inner-container">
                    <div class="logo-box">
                        <a href="/">
                            <img src="assets/images/huazong-logo.png" alt="" width="230">
                        </a>
                    ...
                    <div class="main-nav__main-navigation">
                        ...
                        <li><a href="/comming_soon">最新活动</a></li>
                            ...
                            <li class="dropdown">
                                <a href="collection-grid.html">最新活动</a>
                                <ul>
        ...
        <section class="banner-section">
            <div class="banner-carousel thm__owl-carousel owl-theme owl-carousel" data-options='{"loop": true, "items": 1, "margin": 0, "dots": false, "nav": true, "animateOut": &quot;fadeOut&quot;, "animateIn": &quot;fadeIn&quot;, "active": true, "smartSpeed": 1000, "autoplay": true, "autoplayTimeout": 6000, "autoplayHoverPause": false}'>
                ...
                <div class="slide-item">
                    <div class="image-layer lazy-image" style="background-image: url('assets/images/commingsoon.jpg');background-size:500px"></div>

                    <div class="container" style="padding-left:0px;padding:right:0px">
                        <div class="content-box text-center">
                            <h3></h3>
                            <h2></h2>
                            <!-- <div class="btn-box"><a href="/comming_soon" class="thm-btn btn-style-one"></a></div> -->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="footer-widget footer-widget__about">
                                <img src="assets/images/huazong-logo.png" style="margin-bottom:15px" width="330px">
                        ...
                        <div class="col-lg-3">
                            <div class="footer-widget footer-widget__contact">
                                ...
                                <p><a href="mailto:secretariat@dama-huazong.com">secretariat@dama-huazong.com</a></p>
                            </div><!-- /.footer-widget -->
                        </div><!-- /.col-lg-3 -->
                        <div class="col-lg-3">
                ...
                <div class="container" style="padding-left:0px;padding:right:0px">
                    <div class="inner-container">
                        ...
                        <a href="index.html" class="site-footer__bottom-logo">
                            <img src="assets/images/huazong.png" width="90" alt="">
                        </a>
    ...
    <div class="side-menu__block">
        ...
        <div class="side-menu__block-inner ">
            ...
            <p class="side-menu__block__copy">(c) 2023 <a href="#">华总</a> - All rights reserved.</p>
            <div class="side-menu__social">
                <a href="https://www.facebook.com/huazongmy"><i class="fab fa-facebook-f"></i></a>
                <a href="https://www.instagram.com/dama_huazong_official/"><i class="fab fa-instagram"></i></a>
            </div>
