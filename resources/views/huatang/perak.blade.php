<div style="background: #FFFFFF;">
    ...
    <div class="d-flex flex-column flex-sm-row mb-4 px-3">
        <img class="m-4 align-self-center" style="width: 200px;" src="{{ asset('assets/images/huatang-detail/perak-logo.png') }}" alt="霹雳中华大会堂-华总">
        <div class="align-self-center flex-grow-1">
            <h4 class="mx-2">霹雳中华大会堂</h4>
            <p class="mb-0 mx-2" style="font-size: 22px;">Gabungan Persatuan Cina Perak</p>
            <p class="mb-0 mx-2" style="font-size: 22px;">The Federation Of Chinese Associations Perak</p>
        </div>
    </div>
    ...
    <div class="contact-container">
        <div class="contact-card">
            ...
            <h5 class="mb-4">地址</h5>
            <p class="text-wrap">No. 17-A, Jalan Centrepoint 2, Pinji Centrepoint, 31650 Ipoh, Perak, Malaysia.</p>
        </div>
        ...
        <div class="contact-card">
            ...
            <p class="mb-0">Tel: 605-254 8000</p>
            <p class="mb-0">Fax: 605-254 9000</p>
        </div>
        ...
        <div class="contact-card">
            ...
            <h5 class="mb-4">邮箱</h5>
            <p class="mb-0">pcah13@yahoo.com.my</p>
        </div>
        ...
        <div class="contact-card">
            ...
            <h5 class="mb-4">社交网络</h5>
            <a class="mb-0" target="_blank" href="https://www.facebook.com/Dewan-Perhimpunan-China-Perak-%E9%9C%B9%E9%9B%B3%E4%B8%AD%E5%8D%8E%E5%A4%A7%E4%BC%9A%E5%A0%82-118494176217988/">霹雳中华大会堂facebook主页</a>
        </div>
    </div>
