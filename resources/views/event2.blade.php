...
@section('title', '华总与迈沃集团签备忘录　推动大马金融变革 - 大马华总')
                        ...
                        <div class="col-lg-12">
                            <div class="blog-one__single">
                                <div class="blog-one__image">
                                    <img src="{{ asset('assets/images/event-detail/event2.png') }}" alt="">
                                </div><!-- /.blog-one__image -->
                                <div class="blog-one__content">
                                    <ul class="blog-one__meta list-unstyled">
                                        <li>
                                            ...
                                            <a href="#" class="ml-2">28-08-2023 22:11</a>
                                        </li>
                                    </ul><!-- /.blog-one__meta list-unstyled -->
                                    <p style="color:black; font-size:1.2rem">
                                    华总精英智库委员会与迈沃集团旗下的WOWNations，今日签署合作备忘录，以推动我国金融领域的变革。华总会长丹斯里吴添泉表示，我国的数字金融生态系统扮演著推动国家经济转型的重要角色。
                                    <br><br>
                                    近年来，我国的数字金融生态系统经历并取得了重大的进展，因此它仍将继续扮演，推动我国经济转型的重要角色。
                                    <br><br>
                                    据2020年的数据显示，我国在电子支付领域的交易总值达1730亿令吉，显示了人民对无现金支付或电子交易逐渐成熟的态度。可见我国是一个充满活力且具有弹性的经济体国家，因此通过推介WOWNations，将有助于推动我国金融领域的转型和变革。
                                    <br><br>
                                    据大马数字经济公司（MDEC）统计，共有112万名国人参与了该领域，以作为他们主要 或附加的收入来源。零工业不仅有助于国家的多元化发展，同时还能为国人提供新的收入和就业机会。
                                    <br><br>
                                </p>
