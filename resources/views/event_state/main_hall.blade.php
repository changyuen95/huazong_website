    ...
    <div class="col-lg-4 col-md-6">
        <div class="event-three__single">
            ...
            <div class="event-three__content">
                <span>12-7-2023 14:23</span>
                <h3 style="font-size: 17px;line-height: 1.6;"><a href="/event-detail">2023年东盟美食节将于9月19日至10月10日在中国上海国家会展中心盛大举行</a></h3>
                <!-- <p><i class="fa fa-map-marker"></i> 1 West 52 Street, Mangatha</p> -->
                <a href="/event-detail" class="thm-btn event-three__btn" style="border-radius: 10px;">阅读更多</a>
