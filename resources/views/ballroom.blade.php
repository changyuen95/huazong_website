...
<section class="banner-section">
    <div class="banner-carousel thm__owl-carousel owl-theme owl-carousel" data-options='{"loop": true, "items": 1, "margin": 0, "dots": false, "nav": true, "animateOut": &quot;fadeOut&quot;, "animateIn": &quot;fadeIn&quot;, "active": true, "smartSpeed": 1000, "autoplay": true, "autoplayTimeout": 6000, "autoplayHoverPause": false}'>
     ...
     <div class="slide-item">
            <div class="image-layer lazy-image" style="background-image: url('assets/images/ballroom/ballroom4.jpg');"></div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-4">
                        <div class="cta-two__box">
                            ...
                            <h3>地点</h3>
                            <p><b>丹斯里杨忠礼大礼堂<b><br>Wisma Huazong, Lot 15285, Sungai Besi Expy, 43300 Seri Kembangan, Selangor</p>
                    ...
                    <div class="col-lg-4">
                        <div class="cta-two__box" style="width:22rem">
                            ...
                            <h3>设备</h3>
                            <p>空调、麦克风、私人房间、VIP沙发<br>用于茶歇的门厅、基本音响系统以及LED屏幕</p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="featured-collection__left">
                        ...
                        <h1 style="color:#EB1757">丹斯里杨忠礼大礼堂</h1><br>
                        <ul>
                ...
                <div class="col-lg-6">
                    <div class="featured-collection__right">
                        <div class="featured-collection__image">
                            <img src="/assets/images/ballroom/ballroom5.jpg" alt="">
        ...
        "loop": true, "margin": 0, "autoplay": true, "autoplayTimeout": 5000, "autoplayHoverPause": true, "items": 5, "smartSpeed": 700, "dots": false, "nav": true, "responsive": {
            ...
            "0": { "items": 1}
                ...
                <div class="item">
                    <div class="collection-two__single">
                        <div class="collection-two__image">
                            <img style="height:20rem" src="assets/images/ballroom/1.jpeg" alt="">
                ...
                <div class="item">
                    <div class="collection-two__single">
                        <div class="collection-two__image">
                            <img style="height:20rem" src="assets/images/ballroom/2.jpeg" alt="">
                        </div><!-- /.collection-two__image -->
                        <div class="">
                ...
                <div class="item">
                    <div class="collection-two__single">
                        <div class="collection-two__image">
                            <img style="height:20rem" src="assets/images/ballroom/3.jpeg" alt="">
                        </div><!-- /.collection-two__image -->
                        <div class="">
                ...
                <div class="item">
                    <div class="collection-two__single">
                        <div class="collection-two__image">
                            <img style="height:20rem" src="assets/images/ballroom/7.JPG" alt="">
                        </div><!-- /.collection-two__image -->
                        <div class="">
                ...
                <div class="item">
                    <div class="collection-two__single">
                        <div class="collection-two__image">
                            <img style="height:20rem" src="assets/images/ballroom/8.JPG" alt="">
                        </div><!-- /.collection-two__image -->
                        <div class="">
                ...
                <div class="item">
                    <div class="collection-two__single">
                        <div class="collection-two__image">
                            <img style="height:20rem" src="assets/images/ballroom/9.JPG" alt="">
                        </div><!-- /.collection-two__image -->
                        <div class="">
                ...
                <div class="item">
                    <div class="collection-two__single">
                        <div class="collection-two__image">
                            <img style="height:20rem" src="assets/images/ballroom/10.JPG" alt="">
                        </div><!-- /.collection-two__image -->
                        <div class="">
                ...
                <div class="item">
                    <div class="collection-two__single">
                        <div class="collection-two__image">
                            <img style="height:20rem" src="assets/images/ballroom/12.JPG" alt="">
                        </div><!-- /.collection-two__image -->
                        <div class="">
