                        ...
                        <div class="col-lg-12">
                            <div class="blog-one__single">
                                <div class="blog-one__image">
                                    <img src="{{ asset('assets/images/event/china1.jpg') }}" alt="">
                                </div><!-- /.blog-one__image -->
                                <div class="blog-one__content">
                                    <ul class="blog-one__meta list-unstyled">
                                        <li>
                                            ...
                                            <a href="#" class="ml-2">19-04-2024 16:15</a>
                                        </li>
                                    </ul><p style="color:black; font-size:1.2rem">
                                        2024-04-19中国全国政协代表团访华总
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china1.jpg') }}" style="height:100%;width:100%" alt="">
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china2.jpg') }}" style="height:100%;width:100%" alt="">
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china3.jpg') }}" style="height:100%;width:100%" alt="">
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china4.jpg') }}" style="height:100%;width:100%" alt="">
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china5.jpg') }}" style="height:100%;width:100%" alt="">
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china6.jpg') }}" style="height:100%;width:100%" alt="">
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china7.jpg') }}" style="height:100%;width:100%" alt="">
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china8.jpg') }}" style="height:100%;width:100%" alt="">
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china9.jpg') }}" style="height:100%;width:100%" alt="">
                                        <img style="margin-top:20px;height: 100%;width: 100%;" src="{{ asset('assets/images/event/china10.jpg') }}" style="height:100%;width:100%" alt="">
